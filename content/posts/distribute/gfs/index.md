...
date: "2025-07-23"
draft: false
description: "Google文件系统GFS设计，介绍主从架构、数据分片、副本复制及RPC通信机制。"
weight: 3
tags: ["GFS", "分布式存储", "副本"]
categories: ["数据存储"]
---
...
![alt](./resources/file_strong_consistency.png)

- **最坏的一致性** ： 当分布式系统存在两份备份时，若用户写操作请求处理顺序安排不当，就会导致在 A 文件系统中 `a == 2` ，在 B 文件系统中 `a == 1`

![alt](./resources/file_bad_consistency.png)
...
![alt](./resources/gfs_read.png)


- 追加文件: **版本号只有在选择主块时才会更新**

![alt](./resources/gfs_append.png)
...
![alt](./resources/gfs_append_res.png)
