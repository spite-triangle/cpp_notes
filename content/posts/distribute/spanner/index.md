...
date: "2025-07-27"
draft: false
description: "Google Spanner分布式数据库设计，包括TrueTime API、OTS事务协议及Paxos复制机制。"
weight: 10
tags: ["Spanner", "分布式数据库", "Paxos"]
categories: ["数据存储"]
---
...
![alt](./resources/spanner_structure.png)
...
![alt](./resources/spanner_readonly_trans.png)
