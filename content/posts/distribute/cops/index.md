...
date: "2025-08-03"
draft: false
description: "COPS客户端本地数据处理方案，实现绕过主节点的读写操作与最终一致性保证。"
weight: 14
tags: ["COPS", "最终一致", "分布式数据库"]
categories: ["数据存储"]
---
...
![alt](./resources/cops_design_1.png)
...
![alt](./resources/cops_time_sync.png)
...
![alt](./resources/cops_dependent.png)
