...
date: "2025-07-30"
draft: false
description: "Google Farm数据中心数据库部署方案，使用ZooKeeper管理配置与分片数据备份。"
weight: 11
tags: ["Farm", "数据中心", "ZooKeeper"]
categories: ["数据存储"]
---
...
![alt](./resources/farm_structure.png)
...
![alt](./resources/farm_server_memory.png)
...
![alt](./resources/farm_transaction.png)
