...
date: "2025-08-02"
draft: false
description: "Spark大数据处理引擎，在MapReduce基础上引入RDD内存计算优化流式与机器学习支持。"
weight: 12
tags: ["Spark", "大数据处理", "RDD"]
categories: ["计算框架"]
---
...
![alt](./resources/pagrank_example.png)
...
![alt](./resources/lineage_graph.png)
...
![alt](./resources/spark_narrow.png)
...
![alt](./resources/spark_distinct.png)
...
![alt](./resources/spark_wide_failed.png)
