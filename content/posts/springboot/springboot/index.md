...
date: "2026-06-21"
draft: false
description: "概述Spring Boot自动配置、起步依赖等核心特性，使用Initializr生成项目并编写Hello World入门示例。"
weight: 7
tags: ["Spring Boot", "Hello World", "Initializr", "起步依赖"]
categories: ["入门", "基础教程"]
---
...
![alt](./resources/Spring_Initializr.png)
