...
date: "2026-06-20"
draft: false
description: "阐述MVC三层架构思想、DispatcherServlet前端控制器原理及各组件协作流程，搭建开发环境完成路由配置。"
weight: 5
tags: ["DispatcherServlet", "MVC", "Controller", "Model-View"]
categories: ["Web开发", "核心特性"]
---
...
![alt](./resources/springmvc_example.png)
