...
date: "2026-06-22"
draft: false
description: "Spring Boot集成MyBatis，通过@Select注解快速开发或XML配置文件两种模式实现数据访问层。"
weight: 11
tags: ["Spring Boot", "MyBatis", "@Mapper", "集成配置"]
categories: ["数据持久化", "整合教程"]
---
...
![alt](./resources/springboot_mybatis_example.png)
...
![alt](./resources/springboot_mybatis_example_2.png)
