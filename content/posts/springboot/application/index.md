...
date: "2026-06-22"
draft: false
description: "深入Spring应用启动流程、Java事件监听机制、三类启动监听器及Actuator运行监控端点使用。"
weight: 10
tags: ["ApplicationRunner", "CommandLineRunner", "Actuator", "事件监听"]
categories: ["核心特性", "运维监控"]
---


# spring 启动

![alt](./resources/spring.png)

![alt](./resources/spring_run.png)
