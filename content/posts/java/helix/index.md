...
date: "2026-06-24"
draft: false
description: "Helix编辑器在Java/Go项目中的应用，介绍其核心特性与配置文件管理。"
weight: 4
tags: ["Helix", "编辑器配置", "Java"]
categories: ["开发工具"]
---
...
![alt](./resources/helix-architecture.png)
...
![alt](./resources/HELIX-components.png)
