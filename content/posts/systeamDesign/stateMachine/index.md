...
date: "2026-03-08"
draft: false
description: "有限状态机和分层状态机的概念、原理与C++完整实现，适用于游戏角色控制。"
weight: 5
tags: ["状态机", "FSM", "系统设计"]
categories: ["设计模式"]
---
...
![alt](./resources/hierarchy_state.png)
...
![alt](./resources/default_state.png)

上述的层次图可转化成一个树状图

![alt](./resources/state_tree.png)
...
![alt](./resources/example_power.png)
