---
title: "树状/层次结构数据的数据库表"
date: "2026-03-07"
draft: false
description: "树状/层次结构数据的四种数据库表设计模型对比：邻接表、路径枚举、闭包表和嵌套集。"
weight: 4
tags: ["树形结构", "数据库设计", "层次数据"]
categories: ["数据存储"]
---
...
![alt](./resources/adjacencyList.jpg)
...
![alt](./resources/PathEnumeration.jpg)
...
![alt](./resources/nestedSet.jpg)

将集合改为树状结构，**`lft` 和 `rgt`距离值其实就是「中序遍历」**

![alt](./resources/nestedSetTree.jpg)
...
![alt](./resources/nestedSetTree_delete.jpg)
