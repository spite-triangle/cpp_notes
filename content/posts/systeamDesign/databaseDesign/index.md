...
date: "2026-03-07"
draft: false
description: "数据库设计方法论，涵盖E-R建模、范式理论（1NF-BCNF）及规范化流程。"
weight: 1
tags: ["数据库", "E-R模型", "范式"]
categories: ["数据存储"]
---
...
![alt](./resources/er_relationship.jpg)
...
![alt](./resources/er_relationship1.png)

图(a)中零件与产品之间存在多对多的联系「构成」

![alt](../../image/theory/er_relationship2.png)
<!-- WARNING: resource not found: ../../image/theory/er_relationship2.png -->

图(b)中产品、零件与供应商三者之间还存在多对多的联系「供应」

![alt](../../image/theory/er_er_merge.jpg)
<!-- WARNING: resource not found: ../../image/theory/er_er_merge.jpg -->
...
![alt](./resources/er_analyseRedundancy.jpg)
