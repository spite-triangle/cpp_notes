...
date: "2025-01-11"
draft: false
description: "Qt Model/View架构详解，从标准模型到自定义QAbstractItemModel完整实现。"
weight: 5
tags: ["MVC模式", "数据模型"]
categories: ["界面组件"]
---
...
![standard item](./resources/standardItem.png)
...
![listView](./resources/standard_listview.png)
...
![table view](./resources/standard_table.png)
...
![tree view](./resources/standard_tree.png)
...
![Combo_QItemDelegate](./resources/Combo_QItemDelegate.png)
...
![cell Combo](./resources/cell_combox.png)
...
![proxy model](./resources/proxymodel.gif)
