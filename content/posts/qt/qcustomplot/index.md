...
date: "2024-07-20"
draft: false
description: "QCustomPlot轻量级图表库教程，提供折线柱状图绘制及拖拽缩放交互。"
weight: 8
tags: ["QCustomPlot", "数据可视化"]
categories: ["高级技巧"]
---
...
![axis parts](./resources/AxisNamesOverview.png)
...
![axis rect](./resources/AxisRectSpacingOverview.png)
...
![Layout System](./resources/LayoutsystemSketch.png)
...
![legend](./resources/layoutsystem-movinglegend.png)
...
```
![SelectionType](./resources/selectionType.png)
