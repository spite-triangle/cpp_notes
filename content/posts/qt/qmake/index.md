...
date: "2024-03-17"
draft: false
description: "qmake构建系统使用手册，介绍.pro工程文件语法及跨平台配置方法。"
weight: 1
tags: ["qmake", "构建工具"]
categories: ["构建部署"]
---
...
options:
    ...
    -d              打印详细 qmake 编译信息
$ qmake -makefile [options] test.pro # makefile 模式
$ qmake -project [options] 项目文件/文件夹 # 项目模式，会自动生成 .pro 文件
```
