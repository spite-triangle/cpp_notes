...
date: "2024-09-28"
draft: false
description: "CMake是跨平台构建配置生成器，通过CMakeLists.txt生成各平台的原生构建系统。"
weight: 1
tags: ["CMake", "CMakeLists", "find_package", "pkg-config", "目标安装"]
categories: ["构建系统", "跨平台开发"]
---
...
$ pkg-config test --Libs # 查看 test.pc 中的库配置
-L/mnt/e/testspace/pkgconfig  -lz
$ pkg-config test --Cflags # 查看 test.pc 中的头文件配置
-I/mnt/e/testspace/pkgconfig
$ g++ main.cpp `pkg-config --Libs --Cflags lib` # 编译选项
```
