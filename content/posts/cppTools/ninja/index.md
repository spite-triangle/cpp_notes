...
date: "2025-05-21"
draft: false
description: "Ninja是轻量级快速构建系统，通过build.ninja配置文件定义编译规则与目标依赖。"
weight: 1
tags: ["Ninja", "构建系统", "rsp编码", "GCC依赖", "Msvc兼容"]
categories: ["构建系统", "性能优化"]
---
...
```term
$ ninja all # 执行 build all
$ ninja help # 执行 build help
```
