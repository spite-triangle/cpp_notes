...
date: "2024-07-20"
draft: false
description: "TaskFlow 基于有向图的 C++ 并行任务调度与执行框架"
weight: 5
tags: ["taskflow", "parallel", "task-graph", "c++", "concurrency"]
categories: ["第三方库", "并行计算"]
---
...
![graph](./resources/static_graph.svg)
...
![subflow](./resources/subflow_join.svg)
...
![condition](./resources/conditional-tasking.svg)
...
![module](./resources/composition.svg)
