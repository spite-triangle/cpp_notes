...
date: "2024-05-19"
draft: false
description: "Protocol Buffers 数据结构序列化协议的语法规范与使用技巧"
weight: 3
tags: ["protobuf", "proto3", "message", "序列化", "协议"]
categories: ["第三方库", "数据协议"]
---
...
```term
$ git clone -b v26.1 https://github.com/protocolbuffers/protobuf.git # -b 发布版的版本号
$ git submodule update --init --recursive # 下载依赖库
$ mkdir build && cd build
$ cmake  -DCMAKE_INSTALL_PREFIX=./  -Dprotobuf_BUILD_TESTS=OFF  .. # 编译
```
