...
date: "2024-05-19"
draft: false
description: "gRPC 远程过程调用框架的 C++/Python 编译与部署流程"
weight: 2
tags: ["grpc", "rpc", "protobuf", "c++", "python"]
categories: ["第三方库", "分布式通信"]
---
...
```term
$ python -m grpc_tools.protoc -I<dir> --python_out=<dir> --pyi_out=<dir> --grpc_python_out=<dir>  *.proto
```
