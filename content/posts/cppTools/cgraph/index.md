...
date: "2024-07-20"
draft: false
description: "CGraph C++ 图流程执行框架的节点编排与流水线调度"
weight: 6
tags: ["cgraph", "pipeline", "node-graph", "c++", "workflow"]
categories: ["第三方库", "可视化编程"]
---
...
![CGraph](../../image/libThird/CGraph%20Skeleton.jpg)
<!-- WARNING: resource not found: ../../image/libThird/CGraph%20Skeleton.jpg -->
...
![class](./resources/CGraphClass.png)
...
![param](./resources/cgraph_param.png)
