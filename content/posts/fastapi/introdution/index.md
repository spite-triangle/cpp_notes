...
date: "2025-06-22"
draft: false
description: "FastAPI 简介：现代高性能 Python Web 框架，支持异步特性，内置 Swagger UI 文档"
weight: 1
tags: ["fastapi", "web框架", "async", "swagger", "uvicorn"]
categories: ["Web开发"]
---
...
```term
$ python.exe -m venv .env # 创建虚拟环境，用 conda 也行
...
```term
$ uvicorn.exe hello:app --reload # 启动服务
