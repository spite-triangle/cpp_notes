...
date: "2025-06-22"
draft: false
description: "ORM 数据库：Tortoise ORM 异步模型定义，含关系映射、数据迁移与事务管理"
weight: 7
tags: ["fastapi", "Tortoise-ORM", "SQLAlchemy", "数据库", "异步ORM"]
categories: ["Web开发"]
---
...
```term
$ aerich init -t settings.CONFIG_ORM # 根据配置初始化配置
$ tree .
├── demo.py
