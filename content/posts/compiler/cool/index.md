...
date: "2024-11-30"
draft: false
description: "讲解COOL编程语言的语法规则，包括类定义、属性、函数及继承特性。"
weight: 2
tags: ["COOL语言", "面向对象", "语法分析"]
categories: ["语言规范"]
---
...
```term
$ coolc hello.cl # 编译结果为 .s 文件
$ ls
hello.cl hello.s
$ spim hello.s # 模拟运行 .s 文件
```
...
```term
$ coolc demo.cl atoi.cl # A2I 由 atoi.cl 实现
```
