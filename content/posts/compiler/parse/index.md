...
date: "2025-03-02"
draft: false
description: "讲解语法解析技术，涵盖上下文无关文法、LL自上而下分析与Shift-Reduce自下而上等主流解析算法。"
weight: 4
tags: ["语法分析", "LL分析", "LR分析"]
categories: ["编译器前端"]
---
...
![alt](./resources/parse_example.png)
...
![alt](./resources/gammarAmbiguity.png)
...
![alt](./resources/parseIfAmbiguity.png)
...
![alt](./resources/ambiguityPrecedence.png)
...
<video src="./resources/recursiveDescent.mp4" controls="controls" width="100%" height="100%"></video>
...
![alt](./resources/LL1_parsingTable.png)
...
![alt](./resources/firstSetExample.png)
...
![alt](./resources/followSet_example.png)
...
<video src="./resources/reduce.mp4" controls="controls" width="100%" height="100%"></video>
...
<video src="./resources/shift-reduce.mp4" controls="controls" width="100%" height="100%"></video>



![alt](./resources/shift-reduce.png)
...
```math
    ...
    \end{aligned}
```
<video src="./resources/NFA_viable.mp4" controls="controls" width="100%" height="100%"></video>

同样也能将 NFA 转换为 DFA


![alt](./resources/DFA_vaible.png)
