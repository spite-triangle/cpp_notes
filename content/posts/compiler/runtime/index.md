...
date: "2025-01-12"
draft: false
description: "介绍程序运行时内存结构，包括激活记录、栈帧及堆存储模型。"
weight: 6
tags: ["运行时", "内存模型", "栈帧"]
categories: ["编译器后端"]
---
...
![alt](./resources/runtime_memory.png)
...
<video src="./resources/runtime_activationtree.mp4" controls="controls" width="100%" height="100%"></video>


在程序执行中，数据区域内存会有一片专门的内存来存放这个栈结构

![alt](./resources/runtime_memory1.png)
...
![alt](./resources/runtime_activationRecord.png)
...
![alt](./resources/runtime_static.png)
...
![alt](./resources/runtime_memory2.png)
...
![alt](./resources/stackMachine.png)
...
![alt](./resources/stackMachine_example1.png)


**案例：** 计算 `3 + (7 + 5)`


![alt](./resources/stackMachine_example2.png)
