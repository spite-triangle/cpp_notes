...
date: "2025-01-18"
draft: false
description: "通过操作语义定义程序运行规则，涵盖环境、存储及形式化语义描述。"
weight: 8
tags: ["操作语义", "形式化方法", "语义"]
categories: ["编译器原理"]
---
...
![alt](./resources/operatonalSemantics_1.png)


- 变量

![alt](./resources/operatonalSemantics_2.png)

- 变量赋值

![alt](./resources/operatonalSemantics_3.png)

- 条件判断: 区分条件正确和失败两种情况

![alt](./resources/operatonalSemantics_4.png)

![alt](./resources/operatonalSemantics_5.png)


- `while` 循环


![alt](./resources/operatonalSemantics_6.png)

![alt](./resources/operatonalSemantics_7.png)
...
![alt](./resources/operatonalSemantics_8.png)
...
![alt](./resources/operatonalSemantics_9.png)
...
![alt](./resources/operatonalSemantics_10.png)
