...
date: "2025-02-15"
draft: false
description: "讲解MIPS汇编代码生成，包括CPU模型、函数调用及内存布局实现。"
weight: 7
tags: ["汇编语言", "代码生成", "MIPS"]
categories: ["编译器后端"]
---
...
![alt](./resources/assem_example.png)
...
![alt](./resources/smallLanguage.png)
...
![alt](./resources/cgen_add.png)

> 那么是否可以使用 `t1` 来存放 $e_1$ 的计算结果，使得对代码进行优化？**这个么干是错误的。**

![alt](./resources/cgen_add1.png)
...
![alt](./resources/cgen_sub.png)

## if-else


![alt](./resources/cgen_ifelse.png)
...
![alt](./resources/stackMachine_ar.png)
...
![alt](./resources/temporary_equation.png)
...
![alt](./resources/inherite_memory.png)

对于多层继承也是一样处理


![alt](./resources/inherite_memory1.png)
...
![alt](./resources/inherite_memory2.png)
