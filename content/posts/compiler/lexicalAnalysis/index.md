...
date: "2025-03-02"
draft: false
description: "讲解词法分析原理，包括正则表达式理论、有限状态机及NFA到DFA转换。"
weight: 3
tags: ["词法分析", "正则表达式", "有限自动机"]
categories: ["编译器前端"]
---
...
![alt](./resources/finiteAutomataGraph.png)

**案例1：**  $\Sigma = \{0,1\}$，只接受 `1` 输入的状态机如下图所示

![alt](./resources/finiteAutomataExample1.png)
...
![alt](./resources/finiteAutomataExample2.png)
...
![alt](./resources/convertPipeline.png)
...
- $\varepsilon$ 
    ...
    ![alt](./resources/nfa_empty.png)

- `'a'`

    ![alt](./resources/nfa_char.png)

- 正则表达式 $M$ 

    ![alt](./resources/nfa_m.png)

- $AB$

    ![alt](./resources/nfa_ab.png)

- $A + B$

    ![alt](./resources/nfa_a+b.png)

- $A^*$

    ![alt](./resources/nfa_aStart.png)


**案例：** $\Sigma = \{0,1\}$，将 $(1 + 0)^* 1$ 正则表达式转换为 NFA


![alt](./resources/convertNFA.png)
...
![alt](./resources/implementationDFA.png)
