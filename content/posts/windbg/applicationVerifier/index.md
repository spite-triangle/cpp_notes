...
date: "2024-03-02"
draft: false
description: "Application Verifier 应用级验证工具，通过 hook Win32 API 检测堆溢出和内存泄漏等运行时异常。"
weight: 8
tags: ["AppVerifier", "堆溢出", "API hook", "VRF", "运行时检测"]
categories: ["开发工具"]
---
...
![app verifier](./resources/appVerifier.jpg)

```term
$ !gflag # AppVerifier 开启了 vrf 与 hpa
