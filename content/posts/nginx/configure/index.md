...
date: "2025-05-31"
draft: false
description: "Nginx配置详解，涵盖全局块、Event/HTTP/server/location块结构。"
weight: 3
tags: ["Nginx配置", "服务器设置", "location路由"]
categories: ["Web服务"]
---
...
![alt](./resources/example_reverse.png)
...
![alt](./resources/example_balance.png)
...
![alt](./resources/example_static.png)
...
![alt](./resources/example_stable.png)
...
$ sudo apt install keepalived # 在 nginx 服务上安装 keepalive
$ sudo cp /usr/share/doc/keepalived/samples/keepalived.conf.sample /etc/keepalived/keepalived.conf # 准备预设配置文件
$ cat /etc/keepalived/keepalived.conf # 配置文件
