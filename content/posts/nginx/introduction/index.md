...
date: "2025-05-25"
draft: false
description: "Nginx简介与Docker安装指南，介绍高性能HTTP反向代理服务器特性。"
weight: 1
tags: ["Nginx", "Docker部署", "HTTP服务器"]
categories: ["Web服务"]
---
...
```term
$ docker pull nginx # 安装最新版
$ docker run --name demo-nginx -p 8080:80  nginx # 暴露端口
可选的挂载文件
...
![alt](./resources/ngnix.png)


```term
$ docker run -it nginx /bin/bash # 通过该命令进入容器内部
```
