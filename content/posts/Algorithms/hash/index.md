...
date: "2024-08-18"
draft: false
description: "讲解哈希表数组直接映射结构、简单均匀哈希假设及装载因子，介绍除法与乘法等哈希函数的设计原则。"
weight: 5
tags: ["哈希表", "冲突处理", "哈希函数"]
categories: ["数据结构"]
---
...
![alt](./resources/multiHash.png)

其计算结果就相当与在 $[0,2^r]$ 范围内绕圈

![alt](./resources/multiHashExample.png)
...
![alt](./resources/openaddressing.png)
...
![alt](./resources/perfectHashing.png)
