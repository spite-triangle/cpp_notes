...
date: "2024-07-21"
draft: false
description: "介绍算法运行时间评估、渐近记号（O/Ω/Θ/o/ω）及递归求解方法（代换法、递归树、主方法）。"
weight: 1
tags: ["渐近记号", "主方法", "递归求解"]
categories: ["基础理论"]
---
...
![alt](./resources/recuisionTreeExample1.png)

![alt](./resources/recuisionTreeExample2.png)

对于递推式可以通过树状图的形式展开，$T(n)$ 的结果就是树上所有节点之和


![alt](./resources/recuisionTreeExample3.png)
...
![alt](./resources/interpolationSort.png)

![alt](./resources/interpolationSortExample.png)
...
![alt](./resources/mergeSort.png)

![alt](./resources/mergeSortExample.png)
...
![alt](./resources/mergeTimeTree.png)
