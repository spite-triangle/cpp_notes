...
date: "2024-11-10"
draft: false
description: "讲解单源最短路径的两个核心算法：Dijkstra（贪心策略，适用于非负权图）和 Bellman-Ford（支持负权边并可检测负环）。包含松弛操作的严谨证明以及约束图的理论与应用。"
weight: 17
tags: ["Dijkstra", "Bellman-Ford", "松弛操作"]
categories: ["图算法"]
---
...
![alt](./resources/initSingleSource.png)

$v.d$ 表示所有点到 $s$ 的距离，即「估算距离」，会通过 $RELAX$ 算法实时更新；$v.\pi$ 表示点指针

![alt](./resources/dijkstra.png)
...
![alt](./resources/relax.png)

$v.\pi$ 存储的是当前点在最短路径中的前一点，用于组织出最短路径链表

![alt](./resources/dijkstraExample.png)
