...
date: "2024-11-17"
draft: false
description: "讲解全源最短路径的三种方法：朴素迭代（基于Bellman-Ford思想）、Floyd-Warshall动态规划算法（O(V³)）和 Johnson 算法（通过势函数重映射权值后对每点跑Dijkstra，适用于稀疏图的负权边场景）。"
weight: 15
tags: ["Floyd-Warshall", "Johnson算法", "全源最短路径"]
categories: ["图算法"]
---
