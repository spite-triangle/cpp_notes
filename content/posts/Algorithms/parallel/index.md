...
date: "2024-11-24"
draft: false
description: "介绍并行计算的理论模型，包括动态多线程（spawn/sync）、DAG调度、性能评估指标（工时T1、关键路径T∞、加速比）以及贪婪调度器的上限定理。并以矩阵乘法和矩阵向量积为例演示并行算法的设计与分析。"
weight: 16
tags: ["并行计算", "PRAM模型", "动态多线程"]
categories: ["高级主题"]
---
...
![alt](./resources/dynamicThreadGraph.png)
...
![alt](./resources/dynamicThreadCriticalpath.png)
...
![alt](./resources/matvecmainloop.png)

绘制 $ MAT-VEC-MAIN-LOOP(A,x,y,8,1,8)$ 的 DAG 图

![alt](./resources/matvecDAG.png)
...
![alt](./resources/matrixMultThread.png)
