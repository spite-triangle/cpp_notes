...
date: "2024-09-08"
draft: false
description: "介绍跳表的基本结构、检索算法与理论性能分析。从完美跳表的确定性推导（O(2lg n)搜索）出发，引入随机跳表的抛硬币插入策略，并证明层数和搜索时间为O(lg n)是高概率事件。"
weight: 9
tags: ["跳表", "随机化数据结构", "对数时间"]
categories: ["基础算法"]
---
