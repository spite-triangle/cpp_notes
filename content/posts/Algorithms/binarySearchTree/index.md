...
date: "2024-09-07"
draft: false
description: "讲解二叉树遍历、BST 构建与搜索原理，以及随机 BST 期望高度的数学证明。"
weight: 6
tags: ["二叉搜索树", "随机分析", "Jensen 不等式"]
categories: ["基础理论"]
---
...
![alt](./resources/BST_search.png)

## 排序

通过中序遍历二叉搜索树，获取的结果序列便是排序的结果

![alt](./resources/BST_sort.png)
