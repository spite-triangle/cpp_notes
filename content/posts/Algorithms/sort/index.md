...
date: "2024-08-04"
draft: false
description: "讨论排序算法稳定性概念，对比归并排序与快速排序的分治实现及最坏、最好情况分析。"
weight: 3
tags: ["快速排序", "归并排序", "稳定性"]
categories: ["基础算法"]
---
...
![alt](./resources/mergeSortFcn.png)
...
![alt](./resources/quicksortCode.png)

1. Divide : 找一个主元素 $x$，将待排序数组与主元素进行比较，$\le x$ 的值构成左边的数据，$> x$ 的值构成右边的数组

    ![alt](./resources/quickSortPartition.png)
...
```
![alt](./resources/quicksortWorst.png)
...
```
![alt](./resources/quicksortCommon.png)
...
![alt](./resources/randomizedQuicksort.png)
...
![alt](./resources/sortDecisionTree.png)
...
![alt](./resources/countingSort.png)
...
![alt](./resources/countingSortExample.png)
