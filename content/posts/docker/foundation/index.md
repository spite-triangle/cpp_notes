...
date: "2025-03-04"
draft: false
description: "Docker基础理论，介绍守护进程、镜像、容器和仓库四大核心概念及安装配置。"
weight: 1
tags: ["Docker", "入门教程", "架构设计"]
categories: ["核心原理"]
---
...
![windows registry](./resources/windows_registry.jpg)
...
```term
$ sudo systemctl start docker # wsl2 配置好就已经启动，不用执行
...
![docker run](./resources/docker_run.jpg)
