...
date: "2024-03-03"
draft: false
description: "DockerFile语法规则全解，包含关键字说明及多阶段构建完整案例。"
weight: 9
tags: ["Dockerfile", "镜像构建", "Docker"]
categories: ["工具使用"]
---
...
![struct](./resources/dockerfile_struct.jpg)
...
```term
$ docker login # 登录 docker hub 账号
$ docker push author/repository:tag # 发布镜像到 docker hub
```
