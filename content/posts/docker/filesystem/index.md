...
date: "2024-03-03"
draft: false
description: "详解Docker联合文件系统分层原理及容器提交机制。"
weight: 4
tags: ["UnionFS", "镜像结构", "容器底层"]
categories: ["核心原理"]
---
...
![layer](./resources/unionFs_system.jpg)
...
![layer](./resources/unionFs_layer.jpg)
...
![file System](./resources/unionFs_merged.jpg)
...
```term
$ docker commit -a "author" -m "description"  [container]  [repository:tag]
```
