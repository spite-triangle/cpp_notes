...
date: "2026-06-27"
draft: false
description: "TypeScript 类型系统扩展，通过 tsc 编译器将 TS 转换为兼容 JavaScript"
weight: 5
tags: ["typescript", "tsc", "类型检查", "tsconfig.json", "strict模式"]
categories: ["前端基础"]
---
...
$ tsc --init # 初始化生成 tsconfig.json 文件，需要配合 npm init 一起初始化项目
$ tsc --help
Options
