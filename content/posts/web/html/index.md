...
date: "2025-04-24"
draft: false
description: "HTML 文档结构语法，涵盖展示标签、表单控件和 iframe 跨域通信"
weight: 1
tags: ["html", "语义化标签", "viewport", "iframe", "Cross-Origin-Message"]
categories: ["前端基础"]
---
...
![iframe example](./resources/iframe_example.jpg)
...
![polling WebSocket](./resources/polling_websocket.jpg)
