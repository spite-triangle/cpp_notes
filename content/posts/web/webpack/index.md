...
date: "2026-06-27"
draft: false
description: "Webpack 打包工具链，将多文件优化压缩并转换模块化语法为浏览器可执行代码"
weight: 9
tags: ["webpack", "loader", "bundle", "ES6转译", "模块打包"]
categories: ["前端工程化"]
---
...
$ npm install css-loader style-loader # 安装 loader ，可选
```
...
```term
$ webpack # 配置了 webpack.config.js 直接运行
$ webpack ./index.js -o ./bin/out.js # 命令行
Options:
    -o                  打包输出
