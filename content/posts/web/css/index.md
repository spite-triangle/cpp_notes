...
date: "2025-04-27"
draft: false
description: "CSS 样式系统与布局方案，包含选择器、盒子模型和 Flex 弹性布局"
weight: 2
tags: ["css", "选择器", "Flex", "盒子模型", "CSS属性"]
categories: ["前端基础"]
---
...
- `flex-direction` : 决定 `main axis` 的方向，`item` 默认会沿着主轴放置
    ...
    ![alt](./resources/direction.png)

- `flex-wrap` ：`item` 在轴线上放置不下式，如何换行

    ![alt](./resources/wrap.png)

- `justify-content` : 定义 `item` 在 `main axis` 上的对齐方式

    ![alt](./resources/mainaxis.png)

- `align-items` : 定义 `item` 在 `cross axis` 上的对齐方式

    ![alt](./resources/alignitem.png)

- `align-content` : 定义多根轴线的对齐方式，如果项目只有一根轴线，该属性不起作用

    ![alt](./resources/align.png)
