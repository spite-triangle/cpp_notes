...
date: "2024-03-02"
draft: false
description: "从状态机视角理解C程序、汇编程序和编译器的执行机制及操作系统运行方式"
weight: 1
tags: ["状态机", "C语言", "汇编代码", "GDB调试", "编译器优化"]
...
```term
$ man syscall # 查看如何写系统调用
$ gcc -c hello.s # 直接编译汇编
$ ld hello.o # 链接，然后生成可执行文件
```
...
~
:%!xxd
$ xxd test.txt # 将文件二进制读取，转为二进制显示的文本
$ xxd -r test.txt # 将二进制文本，还原回二进制
```
