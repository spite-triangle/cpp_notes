...
date: "2024-05-19"
draft: false
description: "VSCode中无需编程即可实现的语言特性，包括TextMate语法解析、语义高亮和主题配置"
weight: 5
tags: ["vscode", "language-feature", "syntax-highlighting", "textmate", "semantic-token", "lsp"]
...
![scope inspector](./resources/Scopeinspector.png)
...
![Syntax](./resources/syntax_abc.png)
...
![embedded](./resources/embededLanguage.png)
...
![semantic](./resources/semantic.png)
...
![user Snippet](./resources/userSnippet.png)
