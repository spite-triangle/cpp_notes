...
date: "2024-05-25"
draft: false
description: "利用VSCode API和LSP协议实现动态代码分析能力，包括悬停提示、自动补全等功能"
weight: 6
tags: ["vscode", "lsp", "language-server", "hover", "completion", "programming-language-features"]
...
![Programmatic](./resources/programicLanguageFeature.png)
...
![language server](./resources/lsp.png)
...
![lifecycle](./resources/lifecyvle.png)
