...
date: "2024-05-12"
draft: false
description: "基于Debug Adapter Protocol为VSCode开发调试适配器，涵盖配置文件、启动方式与协议通信机制"
weight: 4
tags: ["vscode", "debugger", "dap", "adapter", "launch-configuration"]
...
![debuger](./resources/debug-arch1.png)
