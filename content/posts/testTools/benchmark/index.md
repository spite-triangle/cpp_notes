...
date: "2024-03-02"
draft: false
description: "Google Benchmark性能基准测试编译配置、参数化运行与Fixture用法指南"
weight: 4
tags: ["benchmark", "性能测试", "c++", "基准测试", "CMake"]
categories: ["测试工具"]
---
...
```term
$ g++ main.cpp -I./inc/benchmark -L./lib/benchmark -lbenchmark -lpthread
$ ./a.out
...
```term
$ ./a.out --benchmark_format=<console|json|csv> # 输出格式
$ ./a.out --benchmark_out=<filename> # 输出日志文件 
$ ./a.out --benchmark_out_format=<json|console|csv> # 输出日志文件的格式
$ ./a.out --benchmark_filter=<regex> # 过滤输出 
$ ./a.out --help # 查看其余的命令行
```
...
```term
$ ./a.out --benchmark_context=info='fuck you too'
....
Run on (16 X 2904 MHz CPU s)
Load Average: 0.52, 0.58, 0.59
info: fuck you too
