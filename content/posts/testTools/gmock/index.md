...
date: "2024-03-02"
draft: false
description: "Google Mock Mock对象模拟与参数匹配器行为机制"
weight: 2
tags: ["gmock", "mock", "参数匹配", "测试验证", "c++"]
categories: ["测试工具"]
---
...
**常规匹配器：**
![alt](./resources/matcher_norm.png)

**浮点数：**
![alt](./resources/matcher_float.png)

**字符串：**
![alt](./resources/matcher_string.png)

**容器：**
![alt](./resources/matcher_contain.png)


## 基数(cardinality)

**作用：** 用于 `Time()` 指定方法被调用多少次
![alt](./resources/cardinalities.png)

## 行为(action)

**作用：** 用于指定方法返回类型

![alt](./resources/action.png)
