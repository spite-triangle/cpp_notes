...
date: "2024-03-02"
draft: false
description: "Google Test C++单元测试框架断言、测试宏与事件机制使用指南"
weight: 1
tags: ["gtest", "单元测试", "c++", "断言", "TEST_F"]
categories: ["测试工具"]
---
...
**`bool` 条件检测**
![alt](./resources/compare1.png)

**数值比较**
![alt](./resources/compare2.png)

**字符串比较**
![alt](./resources/compareStr.png)

**浮点数比较**
![alt](./resources/compareFloat.png)
