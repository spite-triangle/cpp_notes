...
date: "2026-08-03"
draft: false
description: "Hugo静态站点生成器简介，涵盖安装与项目目录结构及主题配置。"
weight: 1
tags: ["Hugo", "静态网站", "入门教程"]
categories: ["基础概念"]
---
...
> [!note]
> 到 [github](https://github.com/gohugoio/hugo/releases/) 直接下载 `Extended-Deploy` 版本即可


|功能|标准版 (Standard)|扩展版 (Extended)|扩展/部署版 (Extended/Deploy)|
|-|-|-|-|
|核心功能|✅|✅|✅|
|WebP 图片编码|❌|✅|✅|
|内置 LibSass 支持|❌|✅|✅|
