...
date: "2024-05-12"
draft: false
description: "全面介绍FFmpeg核心库、时间戳概念以及解包解码转码编码打包的C API使用示例"
weight: 5
tags: ["FFmpeg", "libavformat", "AVFrame", "AVPacket", "AVCodecContext", "DTS", "PTS", "解复用", "编解码", "重采样", "H.264", "AAC", "Muxer", "SwsContext", "SwrContext"]
categories: ["多媒体", "工具库"]
---
...
![linesize](./resources/linesize.webp)
...
![decode](./resources/decode_process.webp)
