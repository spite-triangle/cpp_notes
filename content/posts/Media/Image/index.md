...
date: "2024-05-12"
draft: false
description: "介绍图像传感器RAW数据、宽动态WDR/HDR以及JPEG/Exif等图像格式的基础知识"
weight: 1
tags: ["JPEG", "RAW", "WDR", "HDR", "Exif", "Bayer", "图像压缩", "DCT"]
categories: ["多媒体", "图像基础"]
---
...
![orentation](./resources/orientation.png)
...
![value](./resources/orientationValue.png)


## Exiftool

```term
$ exiftool -Orientation=6  test.jpg # 给一张jpg 图片添加旋转信息
$ exiftool -Orientation=  test.jpg # 移除旋转信息
$ exiftool -Orientation  test.jpg # 查看旋转信息
