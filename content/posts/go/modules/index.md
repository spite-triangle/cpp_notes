...
date: "2024-03-02"
draft: false
description: "讲解Go Module依赖管理，包括go.mod配置与GOPATH模式对比分析。"
weight: 4
tags: ["模块管理", "依赖管理", "goproxy"]
categories: ["工程实践"]
---
...
```term
$ go mod init  triangle_test// 初始化项目，不用在 GOPATH 下创建项目
$ ls
go.mod
$ cat go.mod
...
$ go get [包名] # 从远程仓库下载库，下载到了 $GOPATH/pkg/mod/
```
