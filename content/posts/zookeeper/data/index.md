...
date: "2025-11-01"
draft: false
description: "ZooKeeper数据树结构、ZNode类型分类以及节点监听机制的操作方法"
weight: 3
tags: ["ZNode", "数据模型", "持久节点", "临时节点", "Watcher"]
categories: ["中间件", "数据结构"]
---
...
```term
$ create /demo 'demo-value' # 创建永久节点
Created /demo
$ create -s /demo/a 'aaaa' # 创建序列节点
Created /demo/a0000000000
$ create -s /demo/a 'aaaa' 
Created /demo/a0000000001
$ create -e /demo/b 'bbb' # 临时节点
Created /demo/b
```
...
dataLength = 10
numChildren = 0
$ stat /demo # 只查看 znode 状态信息
```

## 修改

```term
$ set /demo/a0000000000 "aaa1" # 修改 sequential 节点需要写全序号
$ set /demo/b "bbb1" 
```
...
```term
$ delete /demo/b  # 只删除一个 znode
$ deleteall /demo # 删除 znode 及其子 znode
```
