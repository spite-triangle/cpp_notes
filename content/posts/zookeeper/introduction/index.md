...
date: "2025-11-01"
draft: false
description: "ZooKeeper分布式服务协调器的核心概念、数据模型与典型应用场景"
weight: 1
tags: ["ZooKeeper", "分布式系统", "协调服务", "观察者模式", "Raft"]
categories: ["中间件", "分布式协调"]
---
...
![alt](./resources/zookeeper_structure.png)
...
![alt](./resources/application_domain.png)
...
![alt](./resources/application_configure.png)
...
![alt](./resources/application_node.png)

## 服务动态上下线

![alt](./resources/application_server.png)

## 软负载均衡

服务访问负载均衡

![alt](./resources/application_balance.png)
...
$ cd /apache-zookeeper-<version>-bin/bin # 进入安装目录
