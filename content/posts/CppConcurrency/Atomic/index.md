...
date: "2025-07-21"
draft: false
description: "系统讲解std::atomic原子类型、CAS比较交换操作、六种内存序语义以及栅栏同步机制。"
weight: 4
tags: ["std::atomic", "内存序", "CAS"]
categories: ["多线程编程"]
---
...
![alt](./resources/atomicOperation.png)

![alt](./resources/atomic_fcn.png)
...
![alt](./resources/release_fence.png)
...
![alt](./resources/acquire_fence.png)
