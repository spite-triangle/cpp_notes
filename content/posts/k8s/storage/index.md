...
date: "2025-09-18"
draft: false
description: "Kubernetes存储体系，Volume类型、PV/PVC与StorageClass动态供给。"
weight: 7
tags: ["PVC", "StorageClass", "持久化存储"]
categories: ["核心组件"]
---
...
```term
$ sudo apt install nfs-utils # 安装
$ sudo systemctl start nfs-server # 启动
$ vim /etc/exports # 配置共享文件夹
/public     192.168.245.0/24(ro)
/protected  192.168.245.0/24(rw)
$ exportfs -f # 应用配置文件
$ sudo systemctl reload nfs-server # 重启服务
$ mount -t nfs 192.168.245.1:/public  /mnt/nfs/public # 其他机器挂载 nfs
```
