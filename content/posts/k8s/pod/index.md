...
date: "2025-09-20"
draft: false
description: "Pod配置详解，涵盖YAML模板、探针类型及生命周期钩子与初始化容器。"
weight: 4
tags: ["Pod", "探针", "生命周期管理"]
categories: ["核心组件"]
---
...
$ kubectl edit pods nginx-demo # 查看 '.yaml' 配置文件
$ kubectl exec  nginx-demo -it -c nginx -- echo hello # 在容器中执行命令
...
Option
    ...
    -c              容器名，'.yaml' 配置文件中配置的
    -n              命名空间
$ kubectl cp nginx-demo:/data/volumes/nginx/html/index.html ./index.html # 复制命令
...
$ kubeclt logs -f <pod-name> # 查看日志
$ kubectl delete pods nginx-demo # 删除
```
...
![alt](./resources/pod_lifecycle.png)
