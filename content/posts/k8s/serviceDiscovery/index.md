...
date: "2025-10-23"
draft: false
description: "Service通信结构与Ingress反向代理配置及内外网访问机制。"
weight: 8
tags: ["Service", "Ingress", "服务发现"]
categories: ["核心组件"]
---
...
```term
$ kubeclt get svc 
$ kubeclt describe svc nginx-svc # 查看详情
...
$ wget http://nginx-svc:80 # 内网访问 Service
$ wget http://nginx-svc.default:80 # 访问其他命名空间的 service
```
