...
date: "2025-09-21"
draft: false
description: "Kubernetes RBAC权限体系，涵盖服务账号与角色绑定关系配置。"
weight: 10
tags: ["RBAC", "权限管理", "k8s安全"]
categories: ["部署运维"]
---
...
```term
$ kubectl get serviceaccount # 获取服务账号
$ kubectl create serviceaccount jenkins # 创建服务账号
$ kubectl create token jenkins # 创建账号的 token 
```
