...
date: "2025-03-06"
draft: false
description: "Django路由系统全面解析，包括路径参数捕获、正则匹配、重定向及命名空间反向解析。"
weight: 4
tags: ["urls.py", "path", "re_path", "RedirectView", "reverse", "namespace"]
categories: ["路由系统", "Web框架核心"]
---
...
```term
$ ptyhon manage.py startapp appa
$ ptyhon manage.py startapp appb
$ tree .
.
├── appa
│   ├── __init__.py
