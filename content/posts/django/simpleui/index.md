...
date: "2025-03-09"
draft: false
description: "SimpleUI美化Admin界面及import-export数据导入导出，含菜单配置自定义按钮和Vue渲染原理。"
weight: 10
tags: ["django-simpleui", "django-import-export", "SIMPLEUI_CONFIG", "actions", "fontawesome", "element-ui"]
categories: ["后台管理", "第三方扩展"]
---
...
```term
$ pip install django-simpleui       # simpleui 插件
$ pip install django-import-export  # 导入导出插件
```
...
![alt](./resources/admin_exportimport.png)
...
![alt](./resources/admin_simpleui.png)
...
![alt](./resources/simpleui_menu.png)
...
![alt](./resources/simpleui_button.png)
...
Requires: django
Required-by: 
$ cd /home/triangle/miniforge3/lib/python3.12/site-packages/simpleui/
$ tree .
├── templates
│   ├── admin                           # admin 相关的模板文件
│   │   ├── 404.html
