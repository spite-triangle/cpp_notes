...
date: "2025-03-09"
draft: false
description: "Admin后台管理系统搭建与二次开发，含模型注册权限控制用户认证系统及模板定制方案。"
weight: 9
tags: ["createsuperuser", "list_display", "get_readonly_fields", "authenticate", "set_password", "is_authenticated"]
categories: ["后台管理", "权限系统"]
---
...
```term
$ python manager.py migrate # 执行迁移脚本
$ \dt # psql 中的指令
                   List of relations
...
$ python manager.py createsuperuser # 创建账号
...
![alt](./resources/user_add.png)

2. 添加权限

![alt](./resources/user_permission.png)

3. 登陆 `gust` 账号

![alt](./resources/admin_gust.png)
...
![alt](./resources/damin_modelVerbase.png)
...
![alt](./resources/admin_booktype.png)
...
![alt](./resources/admin_bookinfo.png)
...
![alt](./resources/admin_site.png)

## 应用名

![alt](./resources/admin_appName.png)
