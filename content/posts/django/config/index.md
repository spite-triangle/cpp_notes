...
date: "2025-03-07"
draft: false
description: "settings.py全局配置详解，涵盖静态媒体资源、多数据库支持、中间件机制与模板引擎设置。"
weight: 2
tags: ["settings", "STATIC_ROOT", "DATABASES", "MIDDLEWARE", "TEMPLATES"]
categories: ["项目配置, 基础概念"]
---
...
```term
$ python manage.py makemigrations # 去检查创建或修改数据库，如果不合法会给出提示，且生成迁移脚本
...
![alt](./resources/django_middle.jpg)
