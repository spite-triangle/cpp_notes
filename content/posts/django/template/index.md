...
date: "2025-03-09"
draft: false
description: "Django内置模板引擎使用详解，包括变量标签、继承过滤器机制及Jinja3双引擎集成方案。"
weight: 6
tags: ["Jinja2", "extends", "forloop", "过滤器", "自定义标签", "context_processors"]
categories: ["前端模板", "Web框架核心"]
---
...
```term
$ pip install jinja2 # 包名没改，版本其实已经是 3.x 版本
```
