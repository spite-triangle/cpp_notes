...
date: "2025-03-06"
draft: false
description: "Django基础概念与项目结构介绍，讲解MTV架构模型及Hello World应用搭建流程。"
weight: 1
tags: ["MTV", "Hello World", "项目管理", "快速开发"]
categories: ["入门教程", "Web框架"]
---
...
```term
$ django-admin startproject project [path] #  创建项目
$ tree .
.
├── project                # 项目名
│   ├── __init__.py
...
```term
$ python manage.py startapp hello # 创建项目
$ tree .
.
├── hello                   # 应用名
│   ├── __init__.py
