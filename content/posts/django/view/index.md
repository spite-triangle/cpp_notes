...
date: "2025-03-08"
draft: false
description: "基于类的视图CBV全套指南，覆盖ListView至DeleteView五种通用视图及数据分页功能。"
weight: 5
tags: ["CBV", "ListView", "DetailView", "CreateView", "UpdateView", "DeleteView", "Paginator"]
categories: ["视图开发", "ORM操作"]
---
...
![alt](./resources/listview_student.png)
...
![alt](./resources/detailview_student.png)
...
![alt](./resources/createview_student.png)
