...
date: "2025-03-08"
draft: false
description: "ORM框架模型定义与查询体系，涵盖字段类型迁移、Q对象高级查询外键多表及事务管理。"
weight: 7
tags: ["ForeignKey", "filter", "Q对象", "annotate", "makemigrations", "transaction.atomic", "F表达式"]
categories: ["ORM操作", "数据库"]
---
...
```term
$ pip install psycopg2    # postgresql 驱动，报错了就装下面的
