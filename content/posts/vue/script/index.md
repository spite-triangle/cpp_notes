...
date: "2025-04-23"
draft: false
description: "Vue脚本开发模式，包括选项式API、组合式API及Hooks代码组织方式"
weight: 3
tags: ["vue", "compositionapi", "optionsapi", "setup", "hooks", "vue3"]
categories: ["核心概念"]
---
...
![alt](./resources/option1.gif) ![alt](./resources/option2.gif)
...
![alt](./resources/composition1.webp)
![alt](./resources/composition2.webp)
...
```term
$ npm.cmd i -D vite-plugin-vue-setup-extend
```
