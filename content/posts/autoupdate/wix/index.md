...
date: "2025-01-08"
draft: false
description: "WiX Toolset从零搭建Windows安装包教程，包含.wxs配置文件编写与heat.exe自动生成。"
weight: 2
tags: ["wix", "MSI", "安装程序"]
categories: ["打包部署"]
---
...
```term
$ candle.exe .\demo.wxs
$ light.exe .\demo.wixobj -ext WixUIExtension # WixUIExtension 指定使用 WixUI_InstallDir 安装界面
```
...
```term
$ heat.exe dir <dir_path> -cg <group_name> -gg -sfrag -template fragment -out <out.wxs>
```
...
$ wix build -o demo.msi demo.wxs
$ wix convert file.wxs  # 转换 v3 语法格式为 v4 或 v5
```
