...
date: "2025-01-18"
draft: false
description: "Squirrel.Windows自动更新框架的下载、安装与使用指南，基于NuGet实现Windows应用的全量增量更新。"
weight: 6
tags: ["squirrel", "自动更新", "Windows"]
categories: ["系统架构"]
---
...
![alt](./resources/nugetSquirrel.png)
...
1. 使用 `nuget` 将应用程序打包成 `.nupkg`，**必须使用 `lib/net45` 文件夹**
    ...
    ![alt](./resources/squirrel-nuget-package-explorer.png)
