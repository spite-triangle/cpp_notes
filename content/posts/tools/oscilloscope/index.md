...
date: "2026-03-07"
draft: false
description: "介绍示波器的基本参数设置、屏幕界面操作与波形测量方法"
weight: 12
tags: ["示波器", "信号检测", "电子测量", "波形分析", "硬件调试"]
categories: ["测试工具", "硬件诊断"]
---
...
![alt](./resources/auto.png)

1. `default`: 配置重置
2. `Auto Setup`: 全自动配置参数

![alt](./resources/box_wave.png)
...
![alt](./resources/control_panel.png)


## 水平控制

![alt](./resources/control_horizontal.png)
...
![alt](./resources/control_vertical.png)
...
![alt](./resources/control_trigger.png)
...
- `setup`: 配置波的展示参数，通过屏幕周围的按钮调节对应菜单设置
  ...
  - ..
    ...
    ![alt](./resources/control_trigger_button.png)
...
![alt](./resources/control_functions.png)
