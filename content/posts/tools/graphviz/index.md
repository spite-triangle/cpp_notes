...
date: "2025-01-18"
draft: false
description: "Graphviz使用DOT语法定义节点和边的有向图无向图，自动生成可视化图形布局。"
weight: 8
tags: ["Graphviz", "DOT", "digraph", "layout", "node", "svg导出"]
categories: ["可视化工具", "图表绘制"]
---
...
```term
$ dot.exe -Tsvg # 控制台直接编写 -T 导出 dot 语句的形式
// 输入 dot 语句
digraph{a->b;} 
$ dot.exe -Tsvg  -o demo.svg  demo.dot # 编译 demo.dot 
```
