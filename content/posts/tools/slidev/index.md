...
date: "2024-07-20"
draft: false
description: "Slidev 基于 Markdown 的 Web 幻灯片制作与演示工具"
weight: 7
tags: ["slidev", "markdown", "demo", "vue", "presentation"]
categories: ["第三方库", "Web开发"]
---
...
![Slidev](./resources/slidev_demo.png)

# 命令行

```term
$ npm i -g @slidev/cli # 低版本的 nodejs 需要升级
$ slidev # 以当前目录当作项目路径，启动 slidev
  ●■▲
