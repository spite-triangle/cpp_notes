...
date: "2025-10-23"
draft: false
description: "Prometheus开源监控告警系统配置：时序数据库、PromQL查询与Grafana可视化集成"
weight: 7
tags: ["Prometheus", "Grafana", "监控系统", "时序数据库", "PromQL"]
categories: ["基础设施"]
---
...
![alt](./resources/promethus_structure.png)
...
```term
$ docker pull prom/prometheus # 拉取镜像
$ docker run -itd  -p 9090:9090 -v prometheus.yml:/etc/prometheus/prometheus.yml prom/prometheus # 启动容器
$ docker exec -it [container id] /bin/sh # 进入容器
$ cat /etc/prometheus/prometheus.yml # 配置文件
```
...
$ docker run -itd -p 3000:3000 grafana/grafana # 启动容器
...
<!-- WARNING: resource not found: ../../image/distributeCluster/prometheus_simple_ui.png -->
...
<!-- WARNING: resource not found: ../../image/distributeCluster/prometheus_promQL.png -->
...
<!-- WARNING: resource not found: ../../image/distributeCluster/prometheus_python.png -->
...
![alt](./resources/grafana_login.png)

- **数据源** : 设置 `prometheus` 服务作为数据源

![alt](./resources/grafana_data.png)

![alt](../../image/distributeCluster/grafana_data_prometheus.png)
<!-- WARNING: resource not found: ../../image/distributeCluster/grafana_data_prometheus.png -->

- **仪表盘**

![alt](./resources/grafana_dashboards.png)
...
![alt](./resources/grafana_dashboards_online.png)

2. 下载配置

![alt](./resources/grafana_dashboards_download.png)

3. 导入配置

![alt](./resources/grafana_dashboards_import.png)


## 告警


![alt](./resources/grafana_alter.png)
