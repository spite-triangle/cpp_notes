---
title: "win32serviceutil"
date: "2025-08-31"
draft: false
description: "Windows后台服务开发笔记，介绍使用win32service注册与管理Python服务。"
weight: 9
tags: ["Windows服务", "Win32 API", "系统编程"]
categories: ["工程实践"]
---
...
$ sc failureflag /help # 必须在 cmd 下执行
用法:
...
$ sc qfailure  <service name> # 查看配置
$ sc qfailureflag <service name> # 查看配置
```
