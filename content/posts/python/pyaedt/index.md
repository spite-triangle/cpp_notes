...
date: "2025-07-18"
draft: false
description: "PyAEDT库使用笔记，介绍通过Python自动化操作Ansys AEDT进行电磁场仿真。"
weight: 12
tags: ["PyAEDT", "安世电气", "EDA"]
categories: ["工程应用"]
---
...
![alt](./resources/hfssWorkflow.png)
...
1. 创建工程。`1` 创建 `project`；`2` 创建 `design`，包含 `Icepak`、`HFSS` 等
    ![alt](./resources/hfss_1.png)

2. 设置求解模型

    ![alt](./resources/hfss_2.png)

3. 调整单位

    ![alt](./resources/hfss_3.png)

4. 创建模型

    ![alt](./resources/hfss_4.png)

5. 调整模型属性，`value` 中可以添加自定义变量，实现参数化控制

    ![alt](./resources/hfss_5.png)

    ![alt](./resources/hfss_51.png)

6. 选中目标边/面/物体，可设置边界条件/激励

    ![alt](./resources/hfss_6.png)

    ![alt](./resources/hfss_7.png)

7. 设置分析规则

    ![alt](./resources/hfss_8.png)

7. 检查项目工程是否正确

    ![alt](./resources/hfss_9.png)

8. 运行工程

    ![alt](./resources/hfss_10.png)

9. 生成曲线结果

    ![alt](./resources/hfss_11.png)

    ![alt](./resources/hfss_12.png)

10. 生成场结果，选中场结果还能查看动画帧结果

    ![alt](./resources/hfss_13.png)

    ![alt](./resources/hfss_14.png)

## 简洁版 API

![alt](./resources/pyaedt.png)
