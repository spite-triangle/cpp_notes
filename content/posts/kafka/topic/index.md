...
date: "2025-10-28"
draft: false
description: "Kafka主题与分区管理机制，涵盖副本分配算法及API调用示例。"
weight: 4
tags: ["Topic", "分区管理", "副本机制"]
categories: ["核心概念"]
---
...
![alt](./resources/topic_create.png)

## 底层通信

`AdminClient` 发送给 `Controller` 请求创建 `Topic` 的网络通信流程

![alt](./resources/kafka_topic.png)
