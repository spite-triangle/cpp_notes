...
date: "2025-11-01"
draft: false
description: "Kafka基于ZooKeeper的集群管理，包括Controller选举与底层通信。"
weight: 3
tags: ["ZooKeeper", "集群管理", "控制器选举"]
categories: ["架构设计"]
---
...
![alt](./resources/zookeeper_operator.png)
...
![alt](./resources/zookeeper_selection.png)

# 集群启动

## 启动流程

![alt](./resources/server_launch_1.png)

![alt](./resources/server_launch_2.png)

![alt](./resources/server_launch_3.png)
