...
date: "2025-10-28"
draft: false
description: "Kafka数据存储机制，包括日志段拆分与索引文件结构及清理策略。"
weight: 6
tags: ["存储管理", "日志分段", "数据持久化"]
categories: ["架构设计"]
---
...
![alt](./resources/kafka_schema.png)
...
```term
$ ./kafka-dump-log.sh --files <file path>  --print-data-log # 查看文件内容
```
...
![alt](./resources/index_query.png)

# 存储流程

![alt](./resources/kafka_log.png)
