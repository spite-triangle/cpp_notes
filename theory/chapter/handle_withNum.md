...
## 1.1. 内核资源共用
<p style="text-align:center;"><img src="/cpp_notes/image/theory/handle_sys.png" width="50%" align="middle" /></p>
...
<p style="text-align:center;"><img src="/cpp_notes/image/theory/memory_old.png" width="50%" align="middle" /></p>

1. 每个进程会有一张“句柄表”，用来存储句柄
2. 句柄指向的是地址放入了真实对象的指针
3. 当对象位置发生变化时，就会更新句柄指向的对象指针

<p style="text-align:center;"><img src="/cpp_notes/image/theory/memory_new.png" width="50%" align="middle" /></p>
